...
# VERTEX_EXPRESS_ENDPOINT=https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent
VERTEX_CLASSIFICATION_ENABLED=true
VERTEX_CLASSIFICATION_MODEL=gemini-3.1-flash-lite-preview
