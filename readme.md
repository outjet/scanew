...
# VERTEX_EXPRESS_ENDPOINT=https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-lite:generateContent
VERTEX_CLASSIFICATION_ENABLED=true
VERTEX_CLASSIFICATION_MODEL=gemini-2.0-flash-lite
